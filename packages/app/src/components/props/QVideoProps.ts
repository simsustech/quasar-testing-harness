...
export const qVideoSchema: PropSchema[] = [
  ...
  { key: 'loading', type: 'select', default: 'eager', options: ['eager', 'lazy'] },
  { key: 'referrerpolicy', type: 'select', default: 'strict-origin-when-cross-origin', options: ['no-referrer', 'no-referrer-when-downgrade', 'origin', 'origin-when-cross-origin', 'same-origin', 'strict-origin', 'strict-origin-when-cross-origin', 'unsafe-url'] },
]
