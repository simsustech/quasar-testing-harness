...
export const qSkeletonSchema: PropSchema[] = [
  ...
  { key: 'type', type: 'select', default: 'rect', options: ['text', 'rect', 'circle', 'QBtn', 'QBadge', 'QChip', 'QToolbar', 'QCheckbox', 'QRadio', 'QToggle', 'QSlider', 'QRange', 'QInput', 'QAvatar'] },
  { key: 'animation', type: 'select', default: 'wave', options: ['wave', 'pulse', 'pulse-x', 'pulse-y', 'fade', 'blink', 'none'] },
