...
import { qTimeDefaults, qTimeSchema } from '../../components/props/QTimeProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QTime</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-time</code> — props driven by URL query string.
    </p>
