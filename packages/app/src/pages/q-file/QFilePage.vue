...
import { qFileDefaults, qFileSchema } from '../../components/props/QFileProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QFile</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-file</code> — props driven by URL query string.
    </p>
