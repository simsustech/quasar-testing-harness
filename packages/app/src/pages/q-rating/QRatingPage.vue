...
import {
  qRatingDefaults,
  qRatingSchema
} from '../../components/props/QRatingProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QRating</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-rating</code> — props driven by URL query string.
    </p>
    ...
    <div
      ...
      "
    >
      <q-rating v-bind="boundProps" />
    </div>

    <ControlPanel
      :schema="qRatingSchema"
      :model-value="props"
      title="QRating"
