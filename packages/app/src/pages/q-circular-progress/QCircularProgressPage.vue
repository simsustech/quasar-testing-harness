...
import {
  qCircularProgressDefaults,
  qCircularProgressSchema
} from '../../components/props/QCircularProgressProps'
...
<template>
  <q-page padding>
    ...
    <div
      ...
      "
    >
      <q-circular-progress v-bind="boundProps" />
    </div>

    <ControlPanel
      :schema="qCircularProgressSchema"
      :model-value="props"
      title="QCircularProgress"
