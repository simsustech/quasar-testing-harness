...
import {
  qVirtualScrollDefaults,
  qVirtualScrollSchema
} from '../../components/props/QVirtualScrollProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QVirtualScroll</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-virtual-scroll</code> — props driven by URL query string.
    </p>
    ...
    <ControlPanel
      :schema="qVirtualScrollSchema"
      :model-value="props"
      title="QVirtualScroll"
