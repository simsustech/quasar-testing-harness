...
import {
  qRadioDefaults,
  qRadioSchema
} from '../../components/props/QRadioProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QRadio</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-radio</code> — props driven by URL query string.
    </p>
