...
import { qDateDefaults, qDateSchema } from '../../components/props/QDateProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QDate</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-date</code> — props driven by URL query string.
    </p>
