...
import {
  qRangeDefaults,
  qRangeSchema
} from '../../components/props/QRangeProps'
import { useQueryProps } from '../../composables/useQueryProps'

const pageDefaults = {
  ...qRangeDefaults,
  modelValue: { min: 25, max: 75 }
} as const
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QRange</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-range</code> — props driven by URL query string.
    </p>
    ...
    <div
      ...
      "
    >
      <q-range v-bind="boundProps" style="width: 300px" />
    </div>
