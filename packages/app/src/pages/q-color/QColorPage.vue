...
import {
  qColorDefaults,
  qColorSchema
} from '../../components/props/QColorProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QColor</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-color</code> — props driven by URL query string.
    </p>
