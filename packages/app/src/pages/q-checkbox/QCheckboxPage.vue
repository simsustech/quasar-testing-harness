...
import {
  qCheckboxDefaults,
  qCheckboxSchema
} from '../../components/props/QCheckboxProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QCheckbox</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-checkbox</code> — props driven by URL query string.
    </p>
    ...
    <div
      ...
      "
    >
      <q-checkbox v-bind="boundProps" v-model="vmodel" />
    </div>

    <ControlPanel
      :schema="qCheckboxSchema"
      :model-value="props"
      title="QCheckbox"
