...
import {
  qBtnToggleDefaults,
  qBtnToggleSchema
} from '../../components/props/QBtnToggleProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QBtnToggle</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-btn-toggle</code> — props driven by URL query string.
    </p>
    ...
    <div
      ...
      "
    >
      <q-btn-toggle v-bind="boundProps" />
    </div>

    <ControlPanel
      :schema="qBtnToggleSchema"
      :model-value="props"
      title="QBtnToggle"
