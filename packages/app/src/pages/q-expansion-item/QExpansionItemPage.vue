...
import {
  ...
  qExpansionItemSchema
} from '../../components/props/QExpansionItemProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QExpansionItem</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-expansion-item</code> — props driven by URL query string.
    </p>
    ...
    <ControlPanel
      :schema="qExpansionItemSchema"
      :model-value="props"
      title="QExpansionItem"
