...
import {
  qSpinnerDefaults,
  qSpinnerSchema
} from '../../components/props/QSpinnerProps'
...
<template>
  <q-page padding>
    <div class="text-h6 q-mb-xs">QSpinner</div>
    <p class="text-grey-7 q-mb-md">
      Route <code>/q-spinner</code> — props driven by URL query string.
    </p>
    ...
    <div
      ...
      "
    >
      <q-spinner v-bind="boundProps" />
    </div>

    <ControlPanel
      :schema="qSpinnerSchema"
      :model-value="props"
      title="QSpinner"
