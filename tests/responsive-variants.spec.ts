...
const VARIANTS: Record<string, { label: string; query: string }[]> = {
  ...
  'q-input': [
    { label: 'filled', query: 'label=Name&modelValue=Jane&color=primary&filled=true' },
    { label: 'outlined', query: 'label=Email&modelValue=hi@me.com&color=primary&outlined=true' },
    { label: 'dense', query: 'label=City&dense=true&outlined=true&color=primary' },
  ],
  'q-toggle': [
  ...
  'q-select': [
    ...
    { label: 'dense', query: 'label=State&dense=true&outlined=true&color=primary' },
  ],
  'q-dialog': [
  ...
  'q-knob': [
    ...
    { label: 'disabled', query: 'modelValue=65&showValue=true&disable=true&color=primary' },
  ],
  'q-slider': [
    { label: 'value-50', query: 'modelValue=50&color=primary&label=true' },
    { label: 'dense', query: 'modelValue=50&dense=true&color=primary&label=true' },
  ],
  'q-range': [
    { label: 'value', query: 'modelValue={"min":20,"max":60}&color=primary&label=true' },
    { label: 'dense', query: 'modelValue={"min":20,"max":60}&dense=true&color=primary&label=true' },
  ],
  'q-pagination': [
  ...
  'q-tooltip': [
    { label: 'visible', query: 'modelValue=true' },
  ],
  'q-menu': [
    { label: 'visible', query: 'modelValue=true' },
  ],
