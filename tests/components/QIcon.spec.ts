...
test.describe('QIcon — prop variations', () => {
  const variants = [
    { label: 'default', query: 'name=i-mdi-rocket-launch-outline' },
    { label: 'color-secondary', query: 'name=i-mdi-rocket-launch-outline&color=secondary' },
    { label: 'size-lg', query: 'name=i-mdi-rocket-launch-outline&size=48px' },
  ]
...
test.describe('q-icon — dark mode', () => {
