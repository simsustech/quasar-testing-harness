...
const SLUG = 'q-inner-loading'
const STYLES = ['md3', 'md2', 'unstyled'] as const

test.describe('QInnerLoading', () => {
...
test.describe('QInnerLoading — prop variations', () => {
  const variants = [
    { label: 'default', query: 'showing=true' },
    { label: 'color-secondary', query: 'showing=true&color=secondary' },
    { label: 'label', query: 'showing=true&label=Loading...' },
    { label: 'size-lg', query: 'showing=true&size=64px' },
  ]
...
test.describe('q-inner-loading — dark mode', () => {
