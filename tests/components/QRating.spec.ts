...
test.describe('QRating — prop variations', () => {
  const variants = [
    { label: 'default-4', query: 'modelValue=4' },
    { label: 'max-3', query: 'modelValue=3&max=3' },
    { label: 'color-secondary', query: 'modelValue=4&color=secondary' },
    { label: 'size-lg', query: 'modelValue=4&size=lg' },
    { label: 'no-dimming', query: 'modelValue=4&noDimming=true' },
    { label: 'disabled', query: 'modelValue=4&disable=true' },
  ]
...
test.describe('q-rating — dark mode', () => {
