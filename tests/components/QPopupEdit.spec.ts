...
const SLUG = 'q-popup-edit'
const STYLES = ['md3', 'md2', 'unstyled'] as const

test.describe('QPopupEdit', () => {
...
test.describe('QPopupEdit — prop variations', () => {
  const variants = [
    { label: 'default', query: '' },
    { label: 'square', query: 'square=true' },
    { label: 'persistent', query: 'persistent=true' },
  ]
...
test.describe('q-popup-edit — dark mode', () => {
