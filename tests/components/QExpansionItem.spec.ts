...
const SLUG = 'q-expansion-item'
const STYLES = ['md3', 'md2', 'unstyled'] as const

test.describe('QExpansionItem', () => {
...
test.describe('QExpansionItem — prop variations', () => {
  const variants = [
    { label: 'default', query: 'label=Getting+started&modelValue=true' },
    { label: 'dense', query: 'label=Getting+started&modelValue=true&dense=true' },
    { label: 'popup', query: 'label=Getting+started&modelValue=true&popup=true' },
    { label: 'switch-toggle-side', query: 'label=Getting+started&modelValue=true&switchToggleSide=true' },
    { label: 'hide-expand-icon', query: 'label=Getting+started&modelValue=true&hideExpandIcon=true' },
    { label: 'expand-separator', query: 'label=Getting+started&modelValue=true&expandSeparator=true' },
  ]
...
test.describe('q-expansion-item — dark mode', () => {
