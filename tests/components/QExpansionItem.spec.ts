...
test.describe('QExpansionItem — prop variations', () => {
  const variants = [
    ...
    {
      label: 'dense',
      query: 'label=Getting+started&modelValue=true&dense=true'
    },
    {
      label: 'popup',
      query: 'label=Getting+started&modelValue=true&popup=true'
    },
    {
      label: 'switch-toggle-side',
      query: 'label=Getting+started&modelValue=true&switchToggleSide=true'
    },
    {
      label: 'hide-expand-icon',
      query: 'label=Getting+started&modelValue=true&hideExpandIcon=true'
    },
    {
      label: 'expand-separator',
      query: 'label=Getting+started&modelValue=true&expandSeparator=true'
    }
  ]
