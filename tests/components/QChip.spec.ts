...
test.describe('QChip — prop variations', () => {
  const variants = [
    {
      label: 'default',
      query: 'label=New&color=primary&icon=i-mdi-star-outline'
    },
    ...
    {
      label: 'removable',
      query: 'label=Removable&color=primary&removable=true'
    },
    ...
    {
      label: 'icon-right',
      query: 'label=Star&color=primary&iconRight=i-mdi-star'
    },
