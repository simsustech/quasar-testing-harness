...
test.describe('QSlider — prop variations', () => {
  const variants = [
    { label: 'default-35', query: 'modelValue=35' },
    { label: 'min', query: 'modelValue=0' },
    { label: 'max', query: 'modelValue=100' },
    { label: 'disabled', query: 'modelValue=35&disable=true' },
    { label: 'color-secondary', query: 'modelValue=60&color=secondary' },
  ]
...
test.describe('q-slider — dark mode', () => {
