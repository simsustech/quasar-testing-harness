...
test.describe('QAvatar — prop variations', () => {
  const variants = [
    { label: 'default', query: 'color=primary&icon=i-mdi-android&size=48px' },
    { label: 'rounded', query: 'color=teal&icon=i-mdi-account&rounded=true' },
    { label: 'square', query: 'color=orange&icon=i-mdi-fire&square=true' },
    { label: 'text-color', query: 'color=purple&textColor=white&icon=i-mdi-star' },
    { label: 'color-secondary', query: 'color=secondary&textColor=white&label=JD' },
    { label: 'size-lg', query: 'color=primary&icon=i-mdi-camera&size=72px' },
    { label: 'size-xs', query: 'color=primary&icon=i-mdi-camera&size=xs' },
    { label: 'size-sm', query: 'color=primary&icon=i-mdi-camera&size=sm' },
    { label: 'size-xl', query: 'color=primary&icon=i-mdi-camera&size=xl' },
    { label: 'font-size-lg', query: 'color=primary&textColor=white&label=JD&fontSize=32px' },
  ]
...
test.describe('q-avatar — dark mode', () => {
