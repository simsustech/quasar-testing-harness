...
test.describe('QBanner — prop variations', () => {
  const variants = [
    { label: 'default', query: 'rounded=true' },
    { label: 'dense', query: 'dense=true&rounded=true' },
    { label: 'inline-actions', query: 'inlineActions=true&rounded=true' },
    { label: 'no-rounded', query: '' }
  ]
...
test.describe('q-banner — dark mode', () => {
