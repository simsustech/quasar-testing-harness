...
const SLUG = 'q-pull-to-refresh'
const STYLES = ['md3', 'md2', 'unstyled'] as const

test.describe('QPullToRefresh', () => {
...
test.describe('QPullToRefresh — prop variations', () => {
  const variants = [
    { label: 'default', query: '' },
    { label: 'disable', query: 'disable=true' }
  ]
...
test.describe('q-pull-to-refresh — dark mode', () => {
