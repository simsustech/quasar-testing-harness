...
const SLUG = 'q-carousel'
const STYLES = ['md3', 'md2', 'unstyled'] as const

test.describe('QCarousel', () => {
...
test.describe('QCarousel — prop variations', () => {
  const variants = [
    { label: 'default', query: '' },
    { label: 'arrows', query: 'arrows=true' },
    { label: 'navigation', query: 'navigation=true' },
    { label: 'vertical', query: 'vertical=true' },
    { label: 'control-color-secondary', query: 'arrows=true&controlColor=secondary' },
  ]
...
test.describe('q-carousel — dark mode', () => {
